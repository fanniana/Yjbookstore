            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li class="active"><a href="#">文学<span class="sr-only">(current)</span></a></li>
          ...
          <div class="col-md-3 jianju">
              <div class="thumbnail">
                <a href="singlebook.do?bname=<%= book.getBname() %>">
                  ...
                  <p class="text-center"><font color="red" class="shu">￥<%= book.getPrice() %></font>&nbsp&nbsp&nbsp&nbsp<button id="additem" type="button" onclick="javascript:window.location.href='addshoppingcart.do?bid=<%= book.getBid() %>&page=1';" class="btn btn-success"> 添加购物车</button></p>       
