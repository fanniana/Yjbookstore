<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import="java.util.List,entity.Book,dao.BookDao,dao.impl.BookDaoImpl,entity.User,dao.UserDao,dao.impl.UserDaoImpl"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
          ...
          <div class="col-md-3 jianju">
              <div class="thumbnail">
                <a href="singlebook.do?bname=<%= book2.getBname() %>">
                  ...
                  <p class="text-center"><font color="red" class="shu">￥<%= book2.getPrice() %></font>&nbsp&nbsp&nbsp&nbsp<button id="additem" type="button" onclick="javascript:window.location.href='addshoppingcart.do?bid=<%= book2.getBid() %>';" class="btn btn-success"> 添加购物车</button></p>       
